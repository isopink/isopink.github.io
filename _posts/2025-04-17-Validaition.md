...
Let us look at how the validation set is created. First, pick $K$ samples from $\mathcal{D}$ to make $\mathcal{D}_{\text{val}}$.

<br>

$$
\text{Let the remaining } N - K \text{ data points be } \mathcal{D}_{\text{train}}.
$$
